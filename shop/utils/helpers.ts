...
import { WOOCOMMERCE_CONFIG, STORAGE_KEYS, SHOP_ROUTES } from './constants';
...
/**
 * Product detail URL — trailing slash matches static export (S3/CloudFront).
 */
export function getProductUrl(productId: number | string): string {
  return `${SHOP_ROUTES.PRODUCT}/${productId}/`;
}
